...
MAXIMUM_CHOOSE_MULTIPLE_LEVEL_TEXT = {
    '1': os.getenv('MAXIMUM_CHOOSE_MULTIPLE_LEVEL_1', 'One'),
    '2': os.getenv('MAXIMUM_CHOOSE_MULTIPLE_LEVEL_2', 'Two'),
    '3': os.getenv('MAXIMUM_CHOOSE_MULTIPLE_LEVEL_3', 'Four'),
    '4': os.getenv('MAXIMUM_CHOOSE_MULTIPLE_LEVEL_4', 'Five')
}
