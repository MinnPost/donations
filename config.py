...
EVENT_SINGLE_UNIT_PRICE = os.getenv('EVENT_SINGLE_UNIT_PRICE')
EVENT_SINGLE_UNIT_FAIR_MARKET_VALUE = os.getenv('EVENT_SINGLE_UNIT_FAIR_MARKET_VALUE')
EVENT_DISCOUNT_SINGLE_UNIT_PRICE = os.getenv('EVENT_DISCOUNT_SINGLE_UNIT_PRICE')
EVENT_PROMO_CODE = os.getenv('EVENT_PROMO_CODE')
EVENT_CAMPAIGN_ID = os.getenv('EVENT_CAMPAIGN_ID')
